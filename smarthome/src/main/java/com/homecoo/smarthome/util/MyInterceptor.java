 ...
 * @Title: MyInterceptor
 * @Description: 拦截器(通过IoC进行实现)
 * @author: lijz
 * @date :2016年2月18日 下午7:09:07
...
public class MyInterceptor implements Interceptor {
	...
	public void setProperties(Properties properties) {
		// TODO Auto-generated method stub
		/*
		 * String prop1 = properties.getProperty("prop1"); String prop2 =
		 * properties.getProperty("prop2"); System.out.println(prop1 + "------"
		 * + prop2);
		 */
	}
	...
	public void setTotalRecord(BoundSql boundSql, MappedStatement mappedStatement, Connection connection) {
		...
		BoundSql countBoundSql = new BoundSql(mappedStatement.getConfiguration(), countSql, boundSql.getParameterMappings(),
