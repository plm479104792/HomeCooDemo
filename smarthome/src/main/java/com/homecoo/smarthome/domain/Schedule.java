...
//    private Date riqi;			//日期(年月日 时分秒)
//    private Date shij;			//时分秒   
    private String riqi;			//日期(年月日 时分秒)
    private String shij;			//时分秒   
    private String state;		//状态  0 代表重复执行的不变 1 代表一次执行的 2 代表一次执行完后的状态
    private String strategy;	//策略   0:表示单次定时任务     1:表示星期重复执行定时任务
	...
	public Schedule(Integer scheduleId, String xingqi,String shijh,String riqi, String shij,
	...
	public String toString() {
		return "Schedule [scheduleId=" + scheduleId + ", xingqi=" + xingqi
				+ ", riqi=" + riqi + ", shij=" + shij + ", state=" + state
				+ ", strategy=" + strategy + ", phoneNum=" + phoneNum
				+ ", deviceNo=" + deviceNo + ", themeNo=" + themeNo
				+ ", gatewayNo=" + gatewayNo + ", deviceState=" + deviceState
				+ ", scheduleName=" + scheduleName + ", packetData="
				+ packetData + ", createTime=" + createTime + ", createBy="
				+ createBy + "]";
	}
