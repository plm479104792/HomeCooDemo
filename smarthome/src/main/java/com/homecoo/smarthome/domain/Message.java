...
public class Message implements Serializable {
	 ...
	 * */
	private List<ThemeMusic> themeMusicList;
	...
	public String toString() {
		return "Message [phoneNum=" + phoneNum + ", generatedId=" + generatedId
				...
				+ ", note=" + note + ", userDeviceSpaceList="
				+ userDeviceSpaceList + ", deviceList=" + deviceList
				+ ", deviceDtoList=" + deviceDtoList + ", appVersion="
				+ appVersion + ", deviceDtoAppList=" + deviceDtoAppList
				+ ", gatewayList=" + gatewayList + ", musicList=" + musicList
				+ ", themeMusic=" + themeMusic + ", themeMusicList="
				+ themeMusicList + ", scheduleId=" + scheduleId
				+ ", scheduleList=" + scheduleList + ", spaceList=" + spaceList
